...
/**
 * Permission Model
 * Manages Dynamic Role Permissions and Privileges
 */
...
class Permission {
    ...
    /**
     * Get all permissions matrix from database
     */
    ...
    /**
     * Get list of active permissions for a specific role
     */
    ...
    public static function can($role, $permissionKey, $pdo = null) {
        if (!$pdo) $pdo = getDbConnection();
        // Superadmin always has full access as fallback
    ...
    /**
     * Update single permission toggle via AJAX
     */
