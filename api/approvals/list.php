...
$stmt = $pdo->prepare("
    SELECT 
        p.*, 
        k.nama_lengkap, k.nik, k.email, k.no_hp, k.alamat as alamat_karyawan, k.tanggal_masuk, k.foto as employee_foto, k.sisa_cuti as sisa_cuti_karyawan, k.departemen_id, k.role as employee_role,
